  ...
  render() {
        ...
        return (
            <div className="sidepanel">
              ...
              <div>
                <label>name: </label>{(this.props.activeBubble.name!==undefined&&this.props.activeBubble.name!=='')?this.props.activeBubble.name:''}
              </div>
              <div>
                <label>duration: </label>{(this.props.activeBubble.duration_seconds!==undefined&&this.props.activeBubble.duration_seconds!=='')?Math.round(this.props.activeBubble.duration_seconds/60) + ' minutes':''}
              </div>
              <div>
                <label>priority: </label>{(this.props.activeBubble.priority!==undefined&&this.props.activeBubble.priority!=='')?this.props.activeBubble.priority:''}
              </div>
              <div>
                <label>due date:</label>{(this.props.activeBubble.duedate!==undefined&&this.props.activeBubble.duedate!=='')?format_duedate:''}
              </div>
              <p>
